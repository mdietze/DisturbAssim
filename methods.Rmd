...
load("rat.RData")
raster::plot(cov04,col=rat$color,axis.args=list(at=seq_along(rat$description),labels=rat$description,cex.axis=0.4),asp=1,main="Land Cover")
